                                ...
                                <div className="table-responsive">
                                    <table className="table table-striped  ">
                                        ...
                                        <tr>
                                            ...
                                            <td> <span className="bfont">  قله اختیاردین     </span> </td>
                                            <td> <span className="bfont">  هرات    </span> </td>
                                            <td> <span className="bfont">  انجیل    </span> </td>
                                            <td> <span className="bfont">  تاریخی    </span> </td>
                                            <td> <span className="bfont">  هرات درب ملک     </span> </td>
                                            <td> <span className="bfont">  2021/01/02   </span> </td>
                                            <td> <span className="bfont">  این یکی از مکان های با شکو میباشد     </span> </td>
                                            <td>
